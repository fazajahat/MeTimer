...
async function createCalendar(playdate, teamname, location, diaryEntry) {
    ...
    const defaultCalendarSource = Platform.OS === "ios" ? await getDefaultCalendarSource() : { isLocalAccount: true, name: "CalendarName" };
...
export default function CalendarPage({ navigation }) {
    ...
    const saveDiaryEntry = () => {
        ...
        setDiaryEntries([...diaryEntries, { date: formattedDate, entry: diaryEntry }]);
    ...
    async function submitJournal() {
        try {
            ...
            const moods = Object.keys(chipsData[rateMood]).filter((key) => chipsData[rateMood][key] === true);
