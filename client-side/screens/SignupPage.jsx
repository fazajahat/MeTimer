...
import { Text, TextInput as PaperInput, Button as PaperButton, DefaultTheme } from "react-native-paper";
    ...
    return (
        <KeyboardAvoidingView style={styles.container_bg} behavior="adjustPan">
            ...
            <View style={styles.container}>
                ...
                />
                {firstName.error ? <Text style={styles.description}>{firstName.error}</Text> : null}
            </View>
            ...
            <View style={styles.container}>
                ...
                />
                {lastName.error ? <Text style={styles.description}>{lastName.error}</Text> : null}
            </View>
            ...
            <View style={styles.container}>
                ...
                />
                {email.error ? <Text style={styles.description}>{email.error}</Text> : null}
            </View>
            ...
            <View style={styles.container}>
                <PaperInput
                    ...
                    secureTextEntry
                />
                {password.error ? <Text style={styles.description}>{password.error}</Text> : null}
            </View>

            <PaperButton mode="contained" onPress={onSignUpPressed} style={[{ marginTop: 24 }, styles.button]} labelStyle={styles.text}>
                Sign Up
            </PaperButton>
